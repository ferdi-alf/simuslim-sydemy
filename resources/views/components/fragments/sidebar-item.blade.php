...
@php
    ...
    $colorMap = [
        ...
        'indigo' => ['bg' => 'bg-indigo-100', 'text' => 'text-indigo-700', 'icon' => 'text-indigo-500'],
    ];
...
<li>
    <a href="{{ $href }}"
        class="flex items-center p-2 rounded-lg group {{ $isActive ? $activeClasses : 'text-gray-500 hover:text-indigo-500 hover:bg-indigo-50' }}">
